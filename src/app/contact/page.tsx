    ...
    <main className="bg-cream text-ink">
      ...
      <section className="bg-ink px-6 py-16 text-gallery-white lg:px-10 lg:py-24">
        <div className="mx-auto grid max-w-site gap-12 lg:grid-cols-[0.8fr_1fr]">
          ...
          >
            <div>
              <label htmlFor="contact-name" className="text-xs font-semibold uppercase tracking-[0.22em] text-gallery-white/70">
                Name
              </label>
              <input
                id="contact-name"
            ...
            <div>
              <label htmlFor="contact-email" className="text-xs font-semibold uppercase tracking-[0.22em] text-gallery-white/70">
                Email
              </label>
              <input
                id="contact-email"
            ...
            <div>
              <label htmlFor="contact-phone" className="text-xs font-semibold uppercase tracking-[0.22em] text-gallery-white/70">
                Phone or WhatsApp
              </label>
              <input
                id="contact-phone"
            ...
            <div>
              <label htmlFor="contact-topic" className="text-xs font-semibold uppercase tracking-[0.22em] text-gallery-white/70">
                Topic
              </label>
              <select
                id="contact-topic"
            ...
            <div className="sm:col-span-2">
              <label htmlFor="contact-message" className="text-xs font-semibold uppercase tracking-[0.22em] text-gallery-white/70">
                Question
              </label>
              <textarea
                id="contact-message"
            ...
            <button
              type="submit"
              className="min-h-13 bg-gold px-8 text-xs font-semibold uppercase tracking-[0.22em] text-ink transition-colors hover:bg-gallery-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold sm:col-span-2"
            >
              Send question
            </button>
          </form>
